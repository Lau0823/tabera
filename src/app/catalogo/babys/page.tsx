...
const productosBaby = [
  { id: 1, name: 'Lavanda Francesa', precio: '$18.500', img: 'https://i.pinimg.com/736x/cd/e3/69/cde369f90899dfa24f7a30d7c5d2e65c.jpg', tag: 'Más Delicado' },
  { id: 2, name: 'Lino Puro & Algodón', precio: '$18.500', img: 'https://i.pinimg.com/736x/fd/ab/42/fdab42f7a6abf9ab93e958fe234218b6.jpg', tag: 'Nuevos Comienzos' },
];

export default function CatalogoBabyShower() {
  const contactar = (prod: string) => window.open(`https://wa.me/573123592141?text=Hola tabera, me interesa la referencia de vela ${prod} para la bienvenida de mi Baby Shower.`, '_blank');
    ...
    <div className="min-h-screen bg-[#FAF8F5] text-[#2C2927] font-sans selection:bg-[#C5A880]/30">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        <div className="mb-16 space-y-2">
          <span className="font-serif italic text-3xl text-[#96a89c] block lowercase">baby shower</span>
          <h1 className="text-4xl md:text-7xl font-black uppercase tracking-tight text-[#C5A880]">La Bienvenida</h1>
        </div>
